		...
		return (
            ...
            <span className="author"><i className="material-icons admin">verified_user</i>{this.props.author}</span></p>
				...
				<div className="options">
					...
					<span onClick={() => { this.setState({ dropdown: !this.state.dropdown }) }} className="more">
						<i className="material-icons">more_horiz</i>
					</span>

					{this.state.dropdown ? (
						<div className="dropdown-container">
							<div className="backdrop" onClick={() => { this.setState({ dropdown: false }) }}>
								<div className="dropdown">
									<h2 className="close">
									Options
									<i onClick={() => { this.setState({ dropdown: false }) }} className="material-icons">close</i></h2>
									<ul>
										<li><a href="/">
