      ...
      <div className="body spaced">
        <main style={{ width: `720px`, margin: `0 auto` }}>
          ...
          <p>
            ...
            uses and protects any information collected when you use this
            website. It’s worth a read, but if you’re short of time, here’s the
            most important stuff:
          </p>
          <ul>
            <li>
              We won’t collect any personal information (eg. name, email
              address) without your explicit permission;
            </li>
          ...
          <p>
            ...
            that we collect about you lawfully and in accordance with the UK
            Data Protection Act 1998. Above and beyond that, we will endeavour
            to use this information in a way that benefits you as a user.
          </p>
          <p>
            When we ask you to provide information by which you can be
            identified when using this website, you can be assured that it will
            only be used in accordance with this privacy statement.
          </p>
          <p>
            Our privacy policy may change from time to time. We’ll do our best
            to let you know but please do check back periodically for updates.
          </p>
          ...
          <p>
            We will only pass your data on to third parties if you have
            explicitly agree that we do so.
          </p>
          <p>
            The reason we collect information like email addresses is to provide
            you with a better service. For example, we need some personal
            details to do the following:
          </p>
          <ul>
            ...
            <li>
              User newsletters (you only receive this if you opt-in to receive
              it)
            </li>
            <li>
          ...
          <p>
            ...
            our website and to share with advertisers. For example, we may tell
            an advertiser that X number of individuals visited a certain area on
            our website. Or that Y number of men and Z number of women filled
            out our registration form, but we would not disclose anything that
          ...
          <p>
            We use cookies with various analytics &amp; usability tools, such
            as:
          </p>
          <ul>
          ...
          <p>
            ...
            modify your browser setting to decline cookies if you prefer. This
          ...
          <p>
            ...
            control over the content or behaviour of external websites, so
            cannot be responsible for the protection and privacy of any
            information which you provide whilst visiting such sites. External
