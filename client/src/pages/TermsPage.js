      ...
      <div className="body spaced">
        <main style={{ width: `720px`, margin: `0 auto` }}>
          ...
          <p>
            ...
            <strong>we</strong>” or “<strong>us</strong>”). We have a UK VAT
            number of 879480072.
          </p>
          <p>
          ...
          <ol class="plain">
              ...
              <ol class="plain">
                <li>
                  ...
                  <ol class="plain">
                    ...
                    <li>
                      C. to interfere with any other person’s use or enjoyment
                      of the Website;
                    </li>
                    <li>
                      D. to send or post any materials which contain viruses,
                      trojan horses, worms, time-bombs, keystroke loggers,
                      spyware, adware or any other harmful programs or code
                      design to adversely affect the operation of any computer
                    ...
                    <li>
                      ...
                      proprietary rights of any party, or content that you do
                  ...
                  <li>
                    ...
                    unless you have a written licence agreement with QNL in
                  ...
                  <li>
                    ...
                    to host, display and otherwise use such material for any
            ...
            <li>
              ...
              <ol class="plain">
                <li>
                  ...
                  photographs, images, text, fonts and designs) is owned by us
                  and our licensors (unless indicated otherwise) and is
                  protected by copyright, trade marks (both registered and
                  unregistered), database rights, design rights and other
                  intellectual property rights.
                </li>
                <li>
                  You may view, retrieve and display the content of the Website
                  on a computer screen or other device which connects to the
                  internet or print one copy of such content for your own
                  personal, non-commercial use, provided you;
                  <ol class="plain">
                    <li>
            ...
            <li>
              ...
              <ol class="plain">
                ...
                <li>
                  ...
                  REVENUE, DATA OR MANAGEMENT TIME ARISING OUT OF OR IN
                  CONNECTION WITH YOUR USE OF THE WEBSITE.
                </li>
                <li>
                  3.3. Subject to clause 3.1, the content of this Website does
                  not constitute professional advice or detailed guidance. While
                  we try to ensure that content on the Website is correct,
                  reputable and of high quality, WE GIVE NO REPRESENTATION OR
                  WARRANTY, WHETHER EXPRESS OR IMPLIED IN RELATION TO THE
                  CONTENT AND AS TO WHETHER THE CONTENT IS ACCURATE COMPLETE OR
                  CURRENT. WE SHALL NOT BE LIABLE FOR ANY RELIANCE PLACED ON ANY
                  OF THE CONTENT ON THE WEBSITE BY YOU OR ANY THIRD PARTY.
                </li>
                <li>
                  3.4. The Website contains reviews of hosting providers and
                  other online services posted by users of the Website. Views
                  expressed in these reviews are the views of the reviewer and
                  not QNL. Subject to Clause 3.1, WE ARE NOT LIABLE TO YOU FOR
                  ANY ERROR OR INACCURACY CONTAINED WITHIN THE REVIEWS OR FOR
                  ANY LOSS OF ANY KIND YOU SUFFER, INCLUDING TO YOUR REPUTATION,
                  AS A RESULT OF THE REVIEWS.
                </li>
                <li>
                  3.5. The Website may contain links to other websites or
                  material that are beyond our control. Subject to clause 3.1,
                  WE ARE NOT RESPONSIBLE FOR THE CONTENT ON ANY THIRD PARTY
                  WEBSITE.
                </li>
                <li>
                ...
                <li>
                  3.7. You acknowledge that the above exclusions and limitation
                  of liability are reasonable given that the Website merely
                  displays information and reviews in relation to third party
            ...
            <li>
              ...
              <ol class="plain">
                <li>
                  ...
                  of the Website after we have given notice. If you do not wish
                  to accept the new Terms you should not continue to use the
                  Website. If you continue to use the Website after the date on
                  which the change comes into effect, your use of the Website
                ...
                <li>
                  ...
                  have against you at a particular time, this does not prevent
            ...
            <li>
              ...
              <ol class="plain">
                <li>
                  6.1. These Terms and any dispute arising out of or in
                  connection with these Terms and your use of the Website shall
                  be subject to the laws of England and Wales. We will try to
                  solve any disagreements quickly and efficiently. If you are
                  not happy with the way we deal with any disagreement and you
                  want to commence court proceedings, you must do so in the
                  courts of England and Wales.
                </li>
                <li>
                  6.2. We make no promise that materials on the Website are
                  appropriate or available for use in locations outside the
                  United Kingdom, and accessing the Website from territories
                  where its contents are illegal or unlawful is prohibited. If
                  you choose to access this Website from locations outside the
                  United Kingdom, you do so on your own initiative and are
